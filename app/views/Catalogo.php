  ...
  <body class="bg-background-light dark:bg-background-dark font-display text-[#111618] dark:text-white">
    <form action="index.php?action=catalogo" method="POST">
        ...
        <div class="layout-container flex h-full grow flex-col">
            <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f3f4] dark:border-b-[#2a3a44] px-10 py-3 bg-white dark:bg-background-dark sticky top-0 z-10">
            <div class="flex items-center gap-4 text-[#111618] dark:text-white">
                ...
                <h2 class="text-[#111618] dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">
                Coti Express
                </h2>
            </div>
            <div class="flex flex-1 justify-end gap-4 items-center">
                <a class="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 gradient-bg text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-4"
            ...
            <div class="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6">
                <div class="flex flex-col gap-3 pb-3 bg-white dark:bg-background-dark rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                <div
                    class="w-full bg-center bg-no-repeat aspect-video bg-cover"
                    data-alt="Marble Countertop"
                    style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuC2myVdup0ednHaimPMQiHUt46_EyIKQCzzBs6wtMdTfs38Qk9jp26GoQCud3CJKJPPv5dxjmGGlKogI-RtA9Tu14lkz1Ur_VZBONplqD3f5msEzqLWSuXMpR0Rt9z5tb-_WP-Il7ewTQKVhU7K6pThIeQ5ofVxmKA8VgyTP8YgrVmPN9OHswBAuW-mPnBH492LHDbHGO6v__rLhmxD-kIcsgvee1YMMDiDwQKyO7o_oXFVWiAtXS-Naky2wYHLoI_n4EEpnq0sHw');"
                ></div>
                <div class="p-4 flex flex-col flex-1">
                    <p class="text-[#111618] dark:text-white text-lg font-bold leading-normal">
                    Encimera de Mármol
                    </p>
                    <p class="text-[#617c89] dark:text-gray-400 text-sm font-normal leading-normal mt-1 flex-grow">
                    ...
                    <p class="font-bold text-[#111618] dark:text-white mt-2">$150.00 / m²</p>
                    </div>
                </div>
                </div>
                ...
                <div
                    ...
                    style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuAUkfAMzj5aiOS5SdzDoT2kmRVI5C0dlz7B_6GxXwQkrMOJBLKfj_3wZR29_px0eRvmxUqvmvcI9Yx_WrxEIrKIH1XpUHtgbHuUrSjfKX-ALRla3e3G6AufO7ltIExN2-NQ0bPaoUy1rzt_quh7cBArCxz7O-1k09GVyT0Oo6URu12mQdF2FdnXS7e5KYrPhnX_ewXBahTq7tEKSwBsVlXAo5gj9RJNFaWsZxsFQRifGd-VvkhNQFe1wIy2jYAOVh701MBlZK_wBg');"
                ></div>
                <div class="p-4 flex flex-col flex-1">
                    <p class="text-[#111618] dark:text-white text-lg font-bold leading-normal">
                    Piso de Madera
                    ...
                    <p class="font-bold text-[#111618] dark:text-white mt-2">$120.00 / m²</p>
                    </div>
                </div>
                </div>
                ...
                <div
                    ...
                    style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuDPrFDfF2J2BGvI5IyoovFL0mfgu7pMm5ML9HNKMPoCIL5yppQYZsC_zO98DBSUsTXIAYriCT3jBrDyGDRjSwpwLMUtKYsKALk2S56TuYVXi6JaX15RoEBRhWNlJoWBC55mTTwpl5gCbMlJ4GxX2OAAwkdfvZW8C2-isg1n9-EGeDmxcP4AU5vZeI1ZDhhBfaL_HL7CB8ALSwSe1u31PHAQrCtkOUGHBWoLW11fISWMZt01SW29b9r68CUh3u_MQqnczvwbew69_w');"
                ></div>
                <div class="p-4 flex flex-col flex-1">
                    <p class="text-[#111618] dark:text-white text-lg font-bold leading-normal">
                    Encimera de Cuarzo
                    ...
                    <p><b>Medidas:</b> Personalizable</p>
                    <p class="font-bold text-[#111618] dark:text-white mt-2">$130.00 / m²</p>
                    </div>
                </div>
                </div>
                ...
                <div class="p-4 flex flex-col flex-1">
                    ...
                    <p class="font-bold text-[#111618] dark:text-white mt-2">$80.00 / m²</p>
                    </div>
                </div>
                </div>
                ...
                <div
                    ...
                    style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuDk6DyjZu7effZU7mMwcksN8C0SAlfS-t0_TAo0kav-N3ZEF4Qfhw6GCU8niv7pfAgch-F3psJm26718w7BTzzUJbL4dVokzblAsuh4BR1reUkxyFlQQ6A9CoojkNPAvV9uH9KwLsSs-HLutIxc7CHgJYU3HBqtMK9wo17EOqoW5jm8Oa1gUvj4K79hRYaM4t2rEFgtpkuDDBZw1ZqlbDK3vv_dYmWoMuWd4BX_flwk8tykXM4w3jCahRqvRjSNKS-EvuYDFJ0Q3g');"
                ></div>
                <div class="p-4 flex flex-col flex-1">
                    <p class="text-[#111618] dark:text-white text-lg font-bold leading-normal">
                    ...
                    <p class="font-bold text-[#111618] dark:text-white mt-2">$60.00 / m²</p>
                    </div>
                </div>
                </div>
                ...
                <div class="p-4 flex flex-col flex-1">
                    ...
                    <p><b>Uso:</b> Cocina</p>
                    <p><b>Medidas:</b> Personalizable</p>
                    <p class="font-bold text-[#111618] dark:text-white mt-2">$140.00 / m²</p>
                    </div>
                </div>
                </div>
            </div>
