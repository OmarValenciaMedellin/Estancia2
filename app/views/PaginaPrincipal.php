...
<?php
  ...
  $model = new UserModel($connection);
  // Define el umbral de bajo stock (cámbialo si quieres)
  $UMBRAL_STOCK = 10;
  // KPIs
...
<body class="bg-background-light dark:bg-background-dark font-display">
  <div class="relative flex min-h-screen w-full flex-col">
    <div class="flex h-full grow flex-row">
      <aside class="flex h-screen min-h-[700px] flex-col justify-between bg-white dark:bg-background-dark p-4 sticky top-0">
        <div class="flex flex-col gap-4">
          <div class="flex items-center gap-3">
            ...
            <h1 class="text-base font-medium leading-normal text-gray-900 dark:text-white">Coti Express</h1>
          </div>
          <nav class="flex flex-col gap-2">
            <a class="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/20 dark:bg-primary/30" href="#">
              ...
              <p class="text-sm font-medium leading-normal text-gray-900 dark:text-white">Panel de Control</p>
            </a>
            <a class="flex items-center gap-3 px-3 py-2" href="index.php?action=cotizaciones">
              <span class="material-symbols-outlined text-gray-500 dark:text-gray-400">request_quote</span>
              <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400">Cotizador</p>
            </a>
            <a class="flex items-center gap-3 px-3 py-2" href="index.php?action=inventario">
              <span class="material-symbols-outlined text-gray-500 dark:text-gray-400">inventory_2</span>
              <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400">Inventario</p>
            </a>
            <a class="flex items-center gap-3 px-3 py-2" href="index.php?action=consultCliente">
              <span class="material-symbols-outlined text-gray-500 dark:text-gray-400">group</span>
              <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400">Clientes</p>
            </a>
            <a class="flex items-center gap-3 px-3 py-2" href="#">
              <span class="material-symbols-outlined text-gray-500 dark:text-gray-400">assessment</span>
              <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400">Reportes</p>
            </a>
            <a class="flex items-center gap-3 px-3 py-2" href="index.php?action=consultVendedor">
              <span class="material-symbols-outlined text-gray-500 dark:text-gray-400">group</span>
              <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400">Vendedores</p>
            </a>
            <a class="flex items-center gap-3 px-3 py-2" href="index.php?action=consultMaterial">
              <span class="material-symbols-outlined text-gray-500 dark:text-gray-400">inventory_2</span>
              <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400">Materiales</p>
            </a>
          </nav>
        </div>
        <div class="flex flex-col gap-2">
          <a class="flex items-center gap-3 px-3 py-2" href="#">
            ...
            <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400">Configuración</p>
          </a>
          <a class="flex items-center gap-3 px-3 py-2" href="index.php?action=login">
            ...
            <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400">Cerrar Sesión</p>
          </a>
        </div>
      </aside>

      <main class="flex-1">
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 dark:border-gray-800 px-10 py-3 bg-white dark:bg-background-dark sticky top-0">
          <div class="flex items-center gap-4 text-gray-900 dark:text-white">
            <h2 class="text-lg font-bold leading-tight tracking-[-0.015em]">Panel de Control</h2>
          </div>
          <div class="flex flex-1 justify-end gap-4">
            ...
            <button class="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-2.5">
        ...
        <div class="p-6 md:p-10">
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
            <div class="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
              <p class="text-base font-medium leading-normal text-gray-900 dark:text-white">Cotizaciones Activas</p>
              <p class="text-2xl font-bold leading-tight tracking-light text-gray-900 dark:text-white">
                <?php echo (int)$cotizacionesActivas; ?>
              </p>
            </div>
            <div class="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
              <p class="text-base font-medium leading-normal text-gray-900 dark:text-white">Valor Total Cotizado</p>
              <p class="text-2xl font-bold leading-tight tracking-light text-gray-900 dark:text-white">
                <?php echo mxn($valorTotalCotizado); ?>
              </p>
            </div>
            <div class="flex flex-col gap-2 rounded-xl p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
              <p class="text-base font-medium leading-normal text-gray-900 dark:text-white">Clientes Registrados</p>
              <p class="text-2xl font-bold leading-tight tracking-light text-gray-900 dark:text-white">
                <?php echo $clientesTotal; ?>
              </p>
              <p class="text-xs text-gray-500 dark:text-gray-400">Total en base de datos</p>
            </div>
                  ...
                  <?php foreach ($criticos as $m): ?>
                    <li class="flex items-center justify-between">
                      ...
                      <span class="px-2 py-1 text-xs font-medium rounded-full 
                                  <?php echo ((int)$m['Cantidad'] <= 2) ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' : 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300'; ?>">
                        <?php echo (int)$m['Cantidad']; ?> u
                      </span>
                    </li>
                  <?php endforeach; ?>
                <?php else: ?>
                  <li class="text-sm text-gray-500 dark:text-gray-400">No hay materiales críticos.</li>
                <?php endif; ?>
              </ul>
          ...
          <div class="flex flex-wrap gap-6 mb-6">
            ...
            <button
              ...
              <a href="index.php?action=cotizaciones" class="truncate">Nueva Cotización</a>
            </button>
            ...
            <button
              ...
              class="flex min-w-[84px] max-w-[480px] flex-1 cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5
                     bg-primary text-white text-base font-bold leading-normal tracking-[0.015em]
                     hover:bg-[#0fbde0] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 active:opacity-90">
              <a href="index.php?action=insertVendedor" class="truncate">Agregar Vendedor</a>
            </button>
            ...
            <button
              ...
              class="flex min-w-[84px] max-w-[480px] flex-1 cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5
                     bg-primary text-white text-base font-bold leading-normal tracking-[0.015em]
                     hover:bg-[#0fbde0] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 active:opacity-90">
              <a href="index.php?action=inventario" class="truncate">Ver Inventario</a>
            </button>

          </div>

          <!-- 🔹 NUEVA SECCIÓN: RESPALDO / RESTAURAR BD -->
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="flex flex-col gap-4 p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <ul class="space-y-4">
                <?php if (!empty($materialesMasUsados)): ?>
                  <?php 
                    // máximo uso para calcular el porcentaje de la barrita
            ...
            <div class="flex flex-col gap-4 p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
              <h3 class="text-base font-medium leading-normal text-gray-900 dark:text-white">Últimos Clientes</h3>
                  ...
                  <?php foreach ($clientesRecientes as $c): ?>
                    <li class="py-2">
                      ...
                      <p class="text-xs text-gray-500 dark:text-gray-400">
                        ...
                        <?php if (!empty($c['correo'])): ?> · <?php echo htmlspecialchars($c['correo']); ?><?php endif; ?>
                      </p>
                    </li>
                  <?php endforeach; ?>
                <?php else: ?>
                  <li class="py-2 text-sm text-gray-500 dark:text-gray-400">Sin registros.</li>
                <?php endif; ?>
              </ul>
          ...
          <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6">
              <h3 class="text-base font-medium leading-normal text-gray-900 dark:text-white">Cotizaciones Recientes</h3>
            </div>
