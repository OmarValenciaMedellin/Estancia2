...
<html class="light" lang="es">
  ...
  <body class="bg-background-light dark:bg-background-dark">
    <!-- Fondo general -->
    <div
      class="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-gradient-to-br from-[#003366] to-[#008080]"
      style='font-family: "Work Sans", "Noto Sans", sans-serif;'
    >
      <div class="flex flex-1 justify-center items-center py-5 px-4">
        <!-- Tarjeta del login -->
        <div
          class="max-w-[480px] w-full bg-white/10 backdrop-blur-sm p-8 rounded-xl shadow-2xl flex flex-col"
        >
          <!-- Logo -->
          ...
          <form action="index.php?action=login" method="POST">
            <h1 class="text-white text-3xl font-bold text-center pb-6">
              Bienvenido a Coti Express
            </h1>

            <!-- Usuario -->
            <label class="flex flex-col w-full mb-4">
              <p class="text-white text-base font-medium pb-2">
                Usuario o Correo Electrónico
              </p>

              <div class="relative">
                <span
                  class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#617c89]"
                >
                  person
                </span>
