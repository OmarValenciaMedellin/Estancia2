        ...
        <div class="flex h-full flex-col justify-between p-4 sticky top-0">
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
              ...
              <a class="flex items-center gap-3 px-3 py-2 text-[#111718] dark:text-white/90 hover:bg-black/5 dark:hover:bg-white/5 rounded-lg" 
              ...
              href="index.php?action=inventario">
                ...
                <p class="text-sm font-medium leading-normal text-gray-500 dark:text-gray-400 hover:bg-black/5  dark:hover:bg-white/5 rounded-lg">Inventario</p>
              </a>
      ...
      <main class="flex-1 p-6 lg:p-10">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="flex flex-wrap justify-between gap-3 mb-8">
            <p class="text-[#111718] dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">
              Gestión de Materiales
            </p>
          </div>

          <!-- Form Section -->
          <section class="bg-white dark:bg-background-dark/80 p-6 rounded-xl shadow-sm mb-10">
            <h2 class="text-[#111718] dark:text-white text-[22px] font-bold leading-tight tracking-[-0.015em] pb-6">
              Añadir Nuevo Material
            </h2>

            <form method="POST" action="index.php?action=insertMaterial" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">

              <!-- Nombre -->
              <label class="flex flex-col">
                <p class="text-[#111718] dark:text-white/90 text-sm font-medium leading-normal pb-2">Nombre del material</p>
                <input
              ...
              <div class="relative flex flex-col">
                <p class="text-[#111718] dark:text-white/90 text-sm font-medium leading-normal pb-2">Categoría</p>
                ...
                <span class="material-symbols-outlined text-[#618389] absolute right-3 top-[38px] pointer-events-none">expand_more</span>
              </div>

              <!-- Unidad de medida -->
              <div class="relative flex flex-col">
                <p class="text-[#111718] dark:text-white/90 text-sm font-medium leading-normal pb-2">Unidad de medida</p>
              ...
              <!-- Precio unitario -->
              <label class="flex flex-col">
                <p class="text-[#111718] dark:text-white/90 text-sm font-medium leading-normal pb-2">Precio unitario</p>
                <div class="relative">
                  <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-[#618389]">S/</span>
                  <input
              ...
              <label class="flex flex-col">
                <p class="text-[#111718] dark:text-white/90 text-sm font-medium leading-normal pb-2">Cantidad en stock</p>
                <input
                  class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#111718] dark:text-white dark:bg-white/5 focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-[#dbe4e6] dark:border-white/10 bg-white h-11 placeholder:text-[#618389] px-3 text-base font-normal leading-normal"
                  placeholder="0"
                  type="number"
              ...
              <label class="flex flex-col md:col-span-2 lg:col-span-3">
                <p class="text-[#111718] dark:text-white/90 text-sm font-medium leading-normal pb-2">Descripción</p>
                <textarea
                  name="Descripcion"
          ...
          <section>
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
              <h2 class="text-[#111718] dark:text-white text-[22px] font-bold leading-tight tracking-[-0.015em]">
                Inventario de Materiales
              </h2>

              <div class="relative w-full md:w-72">
                <span class="material-symbols-outlined text-[#618389] absolute left-3 top-1/2 -translate-y-1/2">search</span>
                <input
              ...
              <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                  <thead class="bg-black/5 dark:bg-white/5">
                    <tr>
                      <th class="px-6 py-4 font-semibold text-[#111718] dark:text-white/90" scope="col">
                        Código
                      </th>
                      <th class="px-6 py-4 font-semibold text-[#111718] dark:text-white/90" scope="col">
                        Nombre
                      ...
                      <th class="px-6 py-4 font-semibold text-[#111718] dark:text-white/90 text-right" scope="col">
                        Acciones
                      </th>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    ...
                    // Aseguramos que la variable exista
                      ...
                      // Si hay materiales, los mostramos
                              ...
                              <td><?php echo $row['Descripcion']; ?></td>
                                ...
                                <td class="px-6 py-4 text-center">
                                  <div class="flex justify-center gap-2">
                                      ...
                                      <button class="p-2 rounded-lg hover:bg-primary/20 text-primary transition-colors">
                                        <a href="index.php?action=actuMaterial&id=<?php echo $row['id_material'] ?>">

                                        <span class="material-symbols-outlined text-xl">edit</span>
                                        </a>
                                      </button>
                                    </a>
                                    <a href="index.php?action=deleteMaterial&id=<?php echo $row['id_material']; ?>">
                                      <button class="p-2 rounded-lg hover:bg-danger/20 text-danger transition-colors">
                    ...
                    ?>
                          <tr>
                            <td colspan="6" class="text-center py-6 text-[#618389]">
