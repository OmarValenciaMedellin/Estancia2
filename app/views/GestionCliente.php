      ...
      <div class="layout-container flex h-full grow flex-col">
        ...
        >
          ...
          <div class="hidden md:flex flex-1 justify-center items-center gap-9">
            ...
            <a href="#" class="text-sm font-bold leading-normal text-primary">Clientes</a>
            <a href="index.php?action=consultVendedor" class="text-sm font-medium leading-normal text-text-light-primary dark:text-text-dark-primaryy">Vendedor</a>
            <a href="index.php?action=cotizaciones" class="text-sm font-medium leading-normal text-text-light-primary dark:text-text-dark-primary"
              >Cotizaciones</a
            >
                ...
                <tbody class="divide-y divide-border-light dark:divide-border-dark">
                    <?php while ($row = $clientes->fetch_assoc()) { ?>
                      ...
                      <tr class="hover:bg-background-light dark:hover:bg-background-dark">
                        ...
                        <td class="px-6 py-4"><?php echo $row['Telefono']; ?></td>
                        ...
                        <td class="px-6 py-4 text-center">
                          <div class="flex justify-center gap-2">
                              ...
                              <button class="p-2 rounded-lg hover:bg-primary/20 text-primary transition-colors">
                                <a href="index.php?action=actuCliente&id=<?php echo $row['id_Cliente'] ?>">

                                <span class="material-symbols-outlined text-xl">edit</span>
                                </a>
                              </button>
                            </a>
                            <a href="index.php?action=deleteCliente&id=<?php echo $row['id_Cliente']; ?>">
