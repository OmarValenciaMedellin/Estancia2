      ...
      <div class="layout-container flex h-full grow flex-col">
        ...
        <main class="flex flex-1 justify-center p-4 sm:p-6 md:p-8">
          <div class="layout-content-container flex flex-col w-full max-w-4xl flex-1 gap-6">
            ...
            <!-- Card Form -->
            <div class="flex flex-col gap-6 rounded-xl border border-border-light dark:border-border-dark bg-content-light dark:bg-content-dark p-6 sm:p-8 shadow-sm">
              <form
                class="flex flex-col gap-6"
                action="index.php?action=actuVendedor"
                method="POST"
              >
                <!-- ID oculto -->
                <input
