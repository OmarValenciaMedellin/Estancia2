...
<html class="light" lang="es">
  <head>
    ...
    <title>Coti Express - Gestión de Vendedor</title>
    ...
    <div class="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden">
      <div class="layout-container flex h-full grow flex-col">
        ...
        >
          ...
          <div class="hidden md:flex flex-1 justify-center items-center gap-9">
            <a
              ...
              >Pagina Principal</a
            >
            <a href="index.php?action=consultCliente" class="text-sm font-medium leading-normal text-text-light-primary dark:text-text-dark-primary">Clientes</a>
            <a href="index.php?action=consultVendedor" class="text-sm font-bold leading-normal text-primary">Vendedor</a>

            <a href="#" class="text-sm font-medium leading-normal text-text-light-primary dark:text-text-dark-primary"
              >Cotizaciones</a
            >
            <a href="index.php?action=consultMaterial" class="text-sm font-medium leading-normal text-text-light-primary dark:text-text-dark-primary"
              >Materiales</a
            >
            <a href="index.php?action=inventario" class="text-sm font-medium leading-normal text-text-light-primary dark:text-text-dark-primary"
              >Inventario</a
            >
          </div>
        ...
        <main class="flex flex-1 justify-center p-4 sm:p-6 md:p-8">
          <div class="layout-content-container flex flex-col w-full max-w-7xl flex-1 gap-6">
            <!-- Page Heading -->
            <div class="flex flex-wrap items-center justify-between gap-4">
              ...
              <button class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] shadow-sm hover:opacity-90 transition-opacity">
                <a href="index.php?action=insertVendedor">
            ...
            >
              <table class="w-full text-left text-sm text-text-light-secondary dark:text-text-dark-secondary">
                <thead class="bg-background-light dark:bg-background-dark text-xs uppercase tracking-wider">
                  <tr>
                ...
                <tbody class="divide-y divide-border-light dark:divide-border-dark">
                    <?php while ($row = $vendedor->fetch_assoc()) { ?>
                      <!-- Fila -->
                      <tr class="hover:bg-background-light dark:hover:bg-background-dark">
                        <td class="px-6 py-4 font-medium text-text-light-primary dark:text-text-dark-primary whitespace-nowrap">
                        ...
                        <td class="px-6 py-4"><?php echo $row['Correo']; ?></td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-center">
                          <div class="flex justify-center gap-2">
                              ...
                              <button class="p-2 rounded-lg hover:bg-primary/20 text-primary transition-colors">
                                <a href="index.php?action=actuVendedor&id=<?php echo $row['id_Usuario'] ?>">

                                <span class="material-symbols-outlined text-xl">edit</span>
                                </a>
                              </button>
                            </a>
                            <a href="index.php?action=deleteVendedor&id=<?php echo $row['id_Usuario']; ?>">
