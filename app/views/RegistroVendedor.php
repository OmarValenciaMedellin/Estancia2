    ...
    <div class="layout-container flex h-full grow flex-col">
      <div class="flex flex-1 justify-center py-5">
        <div class="layout-content-container flex flex-col max-w-[960px] flex-1 bg-white/70 backdrop-blur-sm rounded-xl shadow-2xl">
          ...
          <!-- Header -->
          <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f4f4] px-10 py-4">
          ...
          <main class="flex-1 px-4 sm:px-10 py-8">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <div class="flex w-full flex-col gap-3 text-center">
                <p class="text-text-main text-4xl font-black font-title tracking-tighter">Crear cuenta Vendedor</p>
            ...
            <div id="user-form">
              ...
              <form class="space-y-6 p-4" action="index.php?action=insertVendedor" method="POST">
                <div class="flex flex-col sm:flex-row max-w-full flex-wrap items-start gap-4">
                  <div class="flex flex-col min-w-40 flex-1">
                    <label class="font-body text-sm font-medium leading-normal text-text-main pb-2" for="user-nombre">Nombre</label>
                    <input
                      id="user-nombre"
                      name="nombre"
                      placeholder="Juan"
                  ...
                  <div class="flex flex-col min-w-40 flex-1">
                    <label class="font-body text-sm font-medium leading-normal text-text-main pb-2" for="user-apellido">Apellido</label>
                    <input
                      id="user-apellido"
                      name="apellido"
                      placeholder="Pérez"
                ...
                <div class="flex flex-col sm:flex-row max-w-full flex-wrap items-start gap-4">
                  <div class="flex flex-col min-w-40 flex-1">
                    <label class="font-body text-sm font-medium leading-normal text-text-main pb-2" for="user-matricula">Matrícula</label>
                    <input
                      id="user-matricula"
                      name="matricula"
                  ...
                  <div class="flex flex-col min-w-40 flex-1">
                    <label class="font-body text-sm font-medium leading-normal text-text-main pb-2" for="user-cargo">Cargo</label>
                    <input
                      id="user-cargo"
                      name="cargo"
                ...
                <div class="flex max-w-full flex-wrap items-start gap-4">
                  <div class="flex flex-col min-w-40 flex-1">
                    <label class="font-body text-sm font-medium leading-normal text-text-main pb-2" for="user-email">Correo Electrónico</label>
                    <input
                      id="user-email"
                      name="correo"
                ...
                <div class="flex flex-col sm:flex-row max-w-full flex-wrap items-start gap-4">
                  <div class="flex flex-col min-w-40 flex-1">
                    <label class="font-body text-sm font-medium leading-normal text-text-main pb-2" for="user-password">Contraseña</label>
                ...
                <script>
                  ...
                  togglePass.addEventListener("click", () => {
                    ...
                    icon.textContent = isPassword ? "visibility_off" : "visibility"; // cambia el ícono
                  });
                </script>
                ...
                <center>
                  <button
                    ...
                    <span class="truncate font-body">Registrar vendedor</span>
                  </button>
                  <br /><br />
                  <a href="index.php?action=inicio" class="flex w-full min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-4 bg-gradient-to-r from-button-start to-button-end text-white text-base font-bold leading-normal tracking-[0.015em] hover:opacity-90 transition-opacity shadow-lg">
                    Regresar
                  </a>
                </center>
              </form>
