    ...
    <div class="relative flex min-h-screen w-full">
      ...
      <main class="flex-1 p-6 lg:p-10">
        <div class="max-w-4xl mx-auto">
          ...
          <section
            class="bg-white dark:bg-background-dark/80 p-6 sm:p-8 rounded-xl shadow-sm"
          >
            <h2
            ...
            <form method="POST" action="index.php?action=actuMaterial" class="grid grid-cols-1 md:grid-cols-2 gap-6">

                 <input type="hidden" name="id_material" value="<?php echo $row['id_material']; ?>">
              ...
              <label class="flex flex-col md:col-span-2">
                ...
                <textarea name = "Descripcion"
                  ...
                  rows="3"> <?php echo htmlspecialchars($row['Descripcion']); ?>
              ...
              <div
                class="md:col-span-2 flex justify-end items-center gap-4 pt-4"
              >
                <button
