...
<html class="light" lang="es">
  ...
  <body class="font-display">
    <div
      class="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden bg-gradient-to-br from-gradient-start to-gradient-end"
    >
      <div class="layout-container flex h-full grow flex-col">
        <div class="px-4 md:px-10 lg:px-40 flex flex-1 justify-center py-5">
          <div
            class="layout-content-container flex flex-col max-w-[960px] flex-1 bg-background-light/90 dark:bg-background-dark/90 rounded-xl shadow-2xl"
          >
            <!-- Header -->
            <header
              class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f4f4]/10 dark:border-b-[#f0f4f4]/10 px-6 sm:px-10 py-4"
            >
              ...
              <?php
                // 👇 Acción actual para resaltar menú
                $action = $_GET['action'] ?? '';
              ?>
              ...
              <div class="hidden md:flex flex-1 justify-end gap-8">
                <div class="text-blue-500  flex items-center gap-9">
                  ...
                  ?>
                    <a
                      <?php echo $action == 'inicio' ? 'text-blue-500 font-bold' : ''; ?>
            ...
            <main class="flex-1 p-4 sm:p-6 lg:p-10">
              ...
              <div class="flex flex-wrap justify-between items-center gap-4 mb-6">
                <p
                  class="text-slate-800 dark:text-white text-4xl font-black leading-tight tracking-[-0.033em] min-w-72"
                >
                  Inventario
                </p>
              </div>
              ...
              <?php if (isset($_GET['error_stock'])): ?>
                <div class="mb-4 px-4 py-2 rounded-lg bg-red-100 text-red-800 text-sm">
                  Error:
                  <?php echo htmlspecialchars($_GET['error_stock'], ENT_QUOTES, 'UTF-8'); ?>
                </div>
              <?php endif; ?>

              <!-- Search and Add -->
              <div
                class="flex flex-col md:flex-row justify-between items-center gap-4 px-4 py-3 bg-white/80 dark:bg-black/20 rounded-lg mb-6"
              >
                <!-- Buscador -->
              ...
              <!-- Tabla -->
              <div
                class="overflow-hidden rounded-lg border border-gray-200/50 dark:border-gray-700/50 bg-white/80 dark:bg-black/20 shadow-md"
              >
                <div class="overflow-x-auto">
                  <table class="w-full">
                    <thead>
                      <tr class="bg-white/10 dark:bg-black/10">
                        <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-gray-300 uppercase tracking-wider">
                          ID
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 dark:text-gray-300 uppercase tracking-wider">
                          Material
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr class="border-t border-gray-100/60 dark:border-gray-800/60">
                          ...
                          <td class="px-6 py-4">
                            ...
                            <form
                              method="POST"
                              action="index.php?action=agregarStock"
                              class="flex items-center gap-2"
                            >
                              <input
                                type="hidden"
                                name="id_material"
                                value="<?php echo (int)$row['id_material']; ?>"
                              />
                      ...
                      ?>
                        <tr>
                          <td colspan="5" class="text-center py-6 text-[#618389]">
              ...
              <?php if (($total_pages ?? 1) > 1): ?>
                <div class="flex items-center justify-center p-4 mt-4 text-slate-800 dark:text-white">
                  <!-- Prev -->
                  <a
                    class="flex size-10 items-center justify-center hover:bg-gray-200/50 dark:hover:bg-gray-700/50 rounded-full"
                  ...
                  <?php
                    ...
                    // Rango simple (puedes mejorar si quieres)
                  ...
                  ?>
                    <a
                      class="text-sm <?php echo $p === $current ? 'font-bold text-white bg-primary' : 'font-normal'; ?> leading-normal flex size-10 items-center justify-center rounded-full mx-1"
