      ...
      <div class="layout-container flex h-full grow flex-col">
        <div class="flex flex-1 justify-center py-5">
          ...
          >
            <!-- HEADER -->
            <header
              class="flex items-center justify-between border-b border-solid border-b-[#f0f4f4] px-10 py-4"
            >
              ...
              <div class="flex items-center gap-4">
                <p class="text-text-secondary text-sm hidden sm:block">
                  ¿Ya tienes una cuenta?
                </p>
                <button
                  class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-transparent text-[#0288d1] border border-[#0288d1] hover:bg-[#0288d1] hover:text-white transition-colors text-sm font-bold leading-normal tracking-[0.015em]"
                >
                  <a href="index.php?action=login" class="truncate">
                    Iniciar Sesión
                  </a>
                </button>
              </div>
                  ...
                  <div class="flex items-start p-1">
                    <div class="flex items-center h-5">
                      <input
                        id="terms-client"
                        type="checkbox"
                        class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-[#0288d1]/50 text-[#009688]"
                        required
                      />
                    </div>
                    <label
                      class="ml-3 text-sm font-medium text-text-secondary font-body"
                      for="terms-client"
                    >
                      Acepto los
                      <a href="#" class="text-[#0288d1] hover:underline">
