...
<body class="bg-background-light dark:bg-background-dark font-display text-[#212529] dark:text-white">
        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            >
                <div class="flex items-center gap-4 text-[#111718] dark:text-white">
                    ...
                    <h2
                        class="text-xl font-bold leading-tight tracking-[-0.015em]"
                    >
                        Coti Express
                    </h2>
                </div>
            ...
            <main class="flex flex-1">
                ...
                >
                    <h3
                        class="text-lg font-semibold leading-normal text-[#111718] dark:text-white"
                    >
                            ...
                            <?php while ($m = $materiales->fetch_assoc()): ?>
                                ...
                                >
                                    <div class="flex items-center gap-3 flex-1">
                                        ...
                                        <div class="flex-1">
                                            <p
                                                class="text-sm font-medium leading-normal text-[#111718] dark:text-white"
                                            >
                ...
                <!-- CONTENIDO PRINCIPAL: COTIZACIÓN -->
                <div class="flex-1 flex flex-col p-8">
                    ...
                    <div class="mt-10">
                        ...
                        <?php if (!empty($listaCotizaciones)): ?>
                            <div class="overflow-x-auto bg-white dark:bg-background-dark rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                                            ...
                                            <tr class="border-t hover:bg-gray-50 dark:hover:bg-gray-900/40">
                                                ...
                                                <td class="px-4 py-2 text-sm text-gray-600 dark:text-gray-300">
                                                    <?php
                                                        if (!empty($row['DetallesMateriales'])) {
                                                            $items = explode(' | ', $row['DetallesMateriales']);
                                                ...
                                                <td class="px-4 py-2">
                                                    <div class="flex gap-2 justify-center">
                                                        <!-- ELIMINAR -->
                                                        <a href="index.php?action=eliminarCotizacion&id=<?php echo $row['id_cotizacion']; ?>"
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 flex flex-col gap-4">
                        ...
                        <!-- FORM FILTRO PARA REPORTE (esto hace que sea REPORTE real) -->
                        <form method="get" action="index.php"
                            ...
                            <button type="submit"
                                class="flex items-center justify-center rounded-lg h-10 md:h-12
                                       bg-[#005f86] text-white gap-2 text-sm font-bold px-6
                                       hover:bg-[#004966] transition-colors">
                                <span class="material-symbols-outlined">picture_as_pdf</span>
                                Generar PDF General
                            </button>
                        </form>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            ...
                            <a href="index.php?action=pdfGraficaMateriales" class="ml-auto">
                                <button
                                class="flex items-center justify-center rounded-lg h-12
                                        bg-purple-600 text-white
                                        gap-2 text-sm font-bold px-6
    ...
    <!-- BUSCADOR DE MATERIALES (FILTRA LADO IZQUIERDO) -->
    <script>
